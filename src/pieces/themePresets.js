...
export const THEME_PRESETS = [
  { id: 'dragon-slate', name: 'Dragon Slate', piece: 'dragons', board: 'slate' },
  { id: 'dragon-wood', name: 'Dragon Wood', piece: 'dragons', board: 'wood' },
  { id: 'dragon-bold', name: 'Dragon Bold', piece: 'dragons-bold', board: 'wood' },
  { id: 'dragon-bold-night', name: 'Bold Night', piece: 'dragons-bold', board: 'night' },
